...
* Студент: [Анастасия Титова](https://up.htmlacademy.ru/htmlcss/24/user/146892).
* Наставник: `Нет`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/146892-technomart-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
